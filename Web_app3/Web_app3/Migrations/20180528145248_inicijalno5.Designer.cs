...
namespace AutoServis.Migrations
{
    ...
    [Migration("20180528145248_inicijalno5")]
    partial class inicijalno5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_app3.Models.Grad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Web_app3.Models.Klijent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Web_app3.Models.Osoba", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Web_app3.Models.Poslovnica", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Web_app3.Models.Uposlenik", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Web_app3.Models.VrstaUposlenika", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("AutoServis.Models.DetaljiProdaje", b =>
                {
                    b.HasOne("Web_app3.Models.Klijent", "Klijent")
                        .WithMany()
                    ...
                    b.HasOne("Web_app3.Models.Uposlenik", "Uposlenik")
                        .WithMany()
            ...
            modelBuilder.Entity("AutoServis.Models.Popravke", b =>
                {
                    b.HasOne("Web_app3.Models.Poslovnica", "Poslovnica")
                        .WithMany()
            ...
            modelBuilder.Entity("Web_app3.Models.Klijent", b =>
                {
                    b.HasOne("Web_app3.Models.Osoba", "Osoba")
                        .WithOne("Klijent")
                        .HasForeignKey("Web_app3.Models.Klijent", "OsobaId")
                        .OnDelete(DeleteBehavior.Restrict);
                });

            modelBuilder.Entity("Web_app3.Models.Osoba", b =>
                {
                    b.HasOne("Web_app3.Models.Grad", "Grad")
                        .WithMany()
            ...
            modelBuilder.Entity("Web_app3.Models.Uposlenik", b =>
                {
                    b.HasOne("Web_app3.Models.Osoba", "Osoba")
                        .WithOne("Uposlenik")
                        .HasForeignKey("Web_app3.Models.Uposlenik", "OsobaId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Web_app3.Models.VrstaUposlenika", "VrstaUposlenika")
                        .WithMany()
